...
{
    NaiveLattice::NaiveLattice(nav_msgs::Odometry odom, double lattice_acc_step, double lattice_time_step, double lattice_max_speed, double lattice_rho, boost::shared_ptr<simple_map_2d::ProbMap2DROS> prob_map)
    : prob_map_(prob_map)
